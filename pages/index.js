// === PLAYOFFS ===
  {id:170,type:"Spread",matchup:"Chiefs -1.5 vs Lions (SB)",odds:"-110",stake:"$750",result:"win",payout:"+$682",date:"Feb 9"},
  {id:169,type:"Player Prop",matchup:"Mahomes O2.5 Pass TDs (SB)",odds:"+120",stake:"$300",result:"win",payout:"+$360",date:"Feb 9"},
  {id:168,type:"Over/Under",matchup:"Chiefs/Lions O49.5 (SB)",odds:"-110",stake:"$200",result:"loss",payout:"-$200",date:"Feb 9"},
  {id:167,type:"Moneyline",matchup:"Chiefs ML (AFCCG)",odds:"-145",stake:"$400",result:"win",payout:"+$276",date:"Jan 26"},
  {id:166,type:"Spread",matchup:"Lions -3 vs Eagles (NFCCG)",odds:"-110",stake:"$350",result:"win",payout:"+$318",date:"Jan 26"},
  {id:165,type:"Player Prop",matchup:"J. Allen O52.5 Rush Yds",odds:"-115",stake:"$100",result:"loss",payout:"-$100",date:"Jan 26"},
  {id:164,type:"Parlay",matchup:"2-Leg: KC ML + DET ML (Conf)",odds:"+260",stake:"$150",result:"win",payout:"+$390",date:"Jan 26"},
  {id:163,type:"Spread",matchup:"Lions -7 vs Commanders (Div)",odds:"-110",stake:"$300",result:"win",payout:"+$273",date:"Jan 19"},
  {id:162,type:"Moneyline",matchup:"Ravens ML vs Bills (Div)",odds:"+130",stake:"$200",result:"loss",payout:"-$200",date:"Jan 19"},
  {id:161,type:"Spread",matchup:"Chiefs -8.5 vs Texans (Div)",odds:"-110",stake:"$300",result:"win",payout:"+$273",date:"Jan 19"},
  {id:160,type:"Player Prop",matchup:"Saquon O95.5 Rush Yds (Div)",odds:"-110",stake:"$150",result:"win",payout:"+$136",date:"Jan 19"},
  {id:159,type:"Moneyline",matchup:"Eagles ML vs Rams (Div)",odds:"-200",stake:"$200",result:"loss",payout:"-$200",date:"Jan 18"},
  {id:158,type:"Teaser",matchup:"3-Team: KC/DET/PHI (Div)",odds:"+180",stake:"$150",result:"win",payout:"+$270",date:"Jan 18"},
  {id:157,type:"Spread",matchup:"Bengals +3 vs Bills (WC)",odds:"-110",stake:"$200",result:"win",payout:"+$182",date:"Jan 12"},
  {id:156,type:"Moneyline",matchup:"Commanders ML vs Bucs (WC)",odds:"+155",stake:"$150",result:"win",payout:"+$233",date:"Jan 12"},
  {id:155,type:"Spread",matchup:"Steelers +7 vs Ravens (WC)",odds:"-110",stake:"$150",result:"loss",payout:"-$150",date:"Jan 11"},
  {id:154,type:"Over/Under",matchup:"Texans/Chargers U43.5 (WC)",odds:"-110",stake:"$150",result:"win",payout:"+$136",date:"Jan 11"},
  // === WEEK 18 ===
  {id:153,type:"Spread",matchup:"Bengals -6 vs Browns",odds:"-110",stake:"$200",result:"win",payout:"+$182",date:"Jan 5"},
  {id:152,type:"Moneyline",matchup:"Lions ML vs Vikings",odds:"-180",stake:"$250",result:"win",payout:"+$139",date:"Jan 5"},
  {id:151,type:"Player Prop",matchup:"Burrow O285.5 Pass Yds",odds:"-115",stake:"$150",result:"win",payout:"+$130",date:"Jan 5"},
  {id:150,type:"Spread",matchup:"Bills -4 vs Patriots",odds:"-110",stake:"$150",result:"win",payout:"+$136",date:"Jan 5"},
  {id:149,type:"Parlay",matchup:"3-Leg: CIN/DET/BUF",odds:"+500",stake:"$75",result:"loss",payout:"-$75",date:"Jan 5"},
  {id:148,type:"Over/Under",matchup:"Chiefs/Broncos O44",odds:"-110",stake:"$100",result:"loss",payout:"-$100",date:"Jan 5"},
  {id:147,type:"Moneyline",matchup:"Eagles ML vs Giants",odds:"-350",stake:"$175",result:"loss",payout:"-$175",date:"Jan 5"},
  {id:146,type:"Spread",matchup:"Ravens -9.5 vs Steelers",odds:"-110",stake:"$150",result:"win",payout:"+$136",date:"Jan 4"},
  // === WEEK 17 ===
  {id:145,type:"Spread",matchup:"Chiefs -3.5 vs Bengals",odds:"-110",stake:"$300",result:"win",payout:"+$273",date:"Dec 28"},
  {id:144,type:"Moneyline",matchup:"Lions ML vs 49ers",odds:"-160",stake:"$200",result:"win",payout:"+$125",date:"Dec 28"},
  {id:143,type:"Player Prop",matchup:"Ja'Marr Chase O95.5 Rec Yds",odds:"-110",stake:"$150",result:"win",payout:"+$136",date:"Dec 28"},
  {id:142,type:"Spread",matchup:"Eagles -7 vs Cowboys",odds:"-110",stake:"$200",result:"win",payout:"+$182",date:"Dec 28"},
  {id:141,type:"Over/Under",matchup:"Bills/Jets O42.5",odds:"-110",stake:"$100",result:"loss",payout:"-$100",date:"Dec 28"},
  {id:140,type:"Teaser",matchup:"2-Team: KC+7/PHI+1",odds:"-110",stake:"$200",result:"win",payout:"+$182",date:"Dec 28"},
  {id:139,type:"Parlay",matchup:"2-Leg: DET ML + BAL ML",odds:"+175",stake:"$150",result:"win",payout:"+$263",date:"Dec 28"},
  {id:138,type:"Moneyline",matchup:"Texans ML vs Titans",odds:"-220",stake:"$110",result:"loss",payout:"-$110",date:"Dec 28"},
  // === WEEK 16 ===
  {id:137,type:"Spread",matchup:"Ravens -6.5 vs Browns",odds:"-110",stake:"$200",result:"win",payout:"+$182",date:"Dec 21"},
  {id:136,type:"Moneyline",matchup:"Bengals ML vs Broncos",odds:"+110",stake:"$150",result:"win",payout:"+$165",date:"Dec 21"},
  {id:135,type:"Player Prop",matchup:"Josh Allen O2.5 Pass TDs",odds:"+130",stake:"$150",result:"win",payout:"+$195",date:"Dec 21"},
  {id:134,type:"Spread",matchup:"Lions -3 vs Bears",odds:"-110",stake:"$200",result:"win",payout:"+$182",date:"Dec 21"},
  ...
  {id:131,type:"Teaser",matchup:"2-Team: BAL+3/DET+3",odds:"-110",stake:"$200",result:"win",payout:"+$182",date:"Dec 21"},
  // === WEEK 15 ===
  {id:130,type:"Spread",matchup:"Chiefs -4 vs Texans",odds:"-110",stake:"$200",result:"win",payout:"+$182",date:"Dec 14"},
  {id:129,type:"Moneyline",matchup:"Packers ML vs Seahawks",odds:"-135",stake:"$135",result:"loss",payout:"-$135",date:"Dec 14"},
  {id:128,type:"Player Prop",matchup:"Lamar O245.5 Pass Yds",odds:"-105",stake:"$150",result:"win",payout:"+$143",date:"Dec 14"},
  {id:127,type:"Spread",matchup:"Bengals -1.5 vs Titans",odds:"-110",stake:"$150",result:"win",payout:"+$136",date:"Dec 14"},
  {id:126,type:"Over/Under",matchup:"Lions/Bills O51.5",odds:"-110",stake:"$150",result:"win",payout:"+$136",date:"Dec 14"},
  {id:125,type:"Moneyline",matchup:"Eagles ML vs Steelers",odds:"-175",stake:"$175",result:"loss",payout:"-$175",date:"Dec 14"},
  {id:124,type:"Parlay",matchup:"3-Leg: KC/CIN/DET",odds:"+350",stake:"$75",result:"win",payout:"+$263",date:"Dec 14"},
  {id:123,type:"Spread",matchup:"Chargers +3.5 vs Bucs",odds:"-110",stake:"$100",result:"loss",payout:"-$100",date:"Dec 14"},
  // === WEEK 14 ===
  {id:122,type:"Spread",matchup:"Lions -7 vs Packers",odds:"-110",stake:"$200",result:"win",payout:"+$182",date:"Dec 7"},
  {id:121,type:"Moneyline",matchup:"Bills ML vs Rams",odds:"-250",stake:"$200",result:"loss",payout:"-$200",date:"Dec 7"},
  {id:120,type:"Player Prop",matchup:"Derrick Henry O85.5 Rush",odds:"-120",stake:"$150",result:"win",payout:"+$125",date:"Dec 7"},
  {id:119,type:"Spread",matchup:"Bengals -3 vs Browns",odds:"-110",stake:"$150",result:"win",payout:"+$136",date:"Dec 7"},
  {id:118,type:"Over/Under",matchup:"Chiefs/Chargers U45",odds:"-110",stake:"$150",result:"win",payout:"+$136",date:"Dec 7"},
  {id:117,type:"Moneyline",matchup:"Vikings ML vs Falcons",odds:"-140",stake:"$140",result:"loss",payout:"-$140",date:"Dec 7"},
  {id:116,type:"Parlay",matchup:"2-Leg: DET ML + CIN ML",odds:"+145",stake:"$125",result:"win",payout:"+$181",date:"Dec 7"},
  // === WEEK 13 ===
  {id:115,type:"Spread",matchup:"Ravens -3.5 vs Eagles",odds:"-110",stake:"$250",result:"win",payout:"+$227",date:"Nov 30"},
  {id:114,type:"Moneyline",matchup:"Chiefs ML vs Raiders",odds:"-400",stake:"$200",result:"loss",payout:"-$200",date:"Nov 30"},
  {id:113,type:"Player Prop",matchup:"Burrow O2.5 Pass TDs",odds:"+105",stake:"$150",result:"win",payout:"+$158",date:"Nov 30"},
  {id:112,type:"Spread",matchup:"49ers -2 vs Bills",odds:"-110",stake:"$100",result:"loss",payout:"-$100",date:"Nov 30"},
  {id:111,type:"Over/Under",matchup:"Lions/Bears O46",odds:"-110",stake:"$150",result:"win",payout:"+$136",date:"Nov 30"},
  {id:110,type:"Moneyline",matchup:"Dolphins ML vs Packers",odds:"+140",stake:"$100",result:"loss",payout:"-$100",date:"Nov 30"},
  {id:109,type:"Teaser",matchup:"2-Team: BAL+3/DET+7",odds:"-110",stake:"$200",result:"win",payout:"+$182",date:"Nov 30"},
  {id:108,type:"Spread",matchup:"Bengals -4.5 vs Steelers",odds:"-110",stake:"$150",result:"win",payout:"+$136",date:"Nov 30"},
  // === WEEKS 8-12 ===
  {id:107,type:"Spread",matchup:"Lions -6 vs Jaguars",odds:"-110",stake:"$200",result:"win",payout:"+$182",date:"Nov 23"},
  {id:106,type:"Moneyline",matchup:"Bengals ML vs Chargers",odds:"+105",stake:"$150",result:"win",payout:"+$158",date:"Nov 23"},
  {id:105,type:"Player Prop",matchup:"Mahomes O275.5 Pass Yds",odds:"-110",stake:"$100",result:"loss",payout:"-$100",date:"Nov 23"},
  {id:104,type:"Spread",matchup:"Bills -3 vs Chiefs",odds:"-110",stake:"$250",result:"loss",payout:"-$250",date:"Nov 23"},
  {id:103,type:"Over/Under",matchup:"Ravens/Steelers U41.5",odds:"-110",stake:"$150",result:"win",payout:"+$136",date:"Nov 23"},
  {id:102,type:"Parlay",matchup:"3-Leg: DET/CIN/PHI",odds:"+450",stake:"$75",result:"loss",payout:"-$75",date:"Nov 23"},
  {id:101,type:"Teaser",matchup:"2-Team: DET+3/CIN+7",odds:"-110",stake:"$150",result:"win",payout:"+$136",date:"Nov 23"},
  {id:100,type:"Spread",matchup:"Eagles -3 vs Commanders",odds:"-110",stake:"$200",result:"win",payout:"+$182",date:"Nov 23"},
  {id:99,type:"Moneyline",matchup:"Chiefs ML vs Bills",odds:"+135",stake:"$200",result:"win",payout:"+$270",date:"Nov 16"},
  {id:98,type:"Spread",matchup:"Lions -4.5 vs Vikings",odds:"-110",stake:"$200",result:"win",payout:"+$182",date:"Nov 16"},
  {id:97,type:"Player Prop",matchup:"Chase O105.5 Rec Yds",odds:"+105",stake:"$150",result:"win",payout:"+$158",date:"Nov 16"},
  {id:96,type:"Spread",matchup:"Bengals -2 vs Raiders",odds:"-110",stake:"$150",result:"win",payout:"+$136",date:"Nov 16"},
  {id:95,type:"Over/Under",matchup:"Bills/Dolphins O48",odds:"-110",stake:"$100",result:"loss",payout:"-$100",date:"Nov 16"},
  {id:94,type:"Moneyline",matchup:"Texans ML vs Colts",odds:"-190",stake:"$190",result:"loss",payout:"-$190",date:"Nov 16"},
  {id:93,type:"Parlay",matchup:"2-Leg: KC ML + DET ML",odds:"+295",stake:"$100",result:"win",payout:"+$295",date:"Nov 16"},
  {id:92,type:"Spread",matchup:"Ravens -6 vs Saints",odds:"-110",stake:"$150",result:"win",payout:"+$136",date:"Nov 9"},
  ...
  {id:88,type:"Over/Under",matchup:"Chiefs/Broncos U43",odds:"-110",stake:"$150",result:"win",payout:"+$136",date:"Nov 9"},
  {id:87,type:"Moneyline",matchup:"49ers ML vs Cardinals",odds:"-200",stake:"$200",result:"loss",payout:"-$200",date:"Nov 9"},
  {id:86,type:"Teaser",matchup:"3-Team: BAL/DET/PHI",odds:"+150",stake:"$150",result:"win",payout:"+$225",date:"Nov 9"},
  {id:85,type:"Spread",matchup:"Bengals -1.5 vs Ravens",odds:"-110",stake:"$250",result:"loss",payout:"-$250",date:"Nov 9"},
  // === WEEKS 5-7 ===
  {id:84,type:"Spread",matchup:"Chiefs -6 vs Titans",odds:"-110",stake:"$200",result:"win",payout:"+$182",date:"Nov 2"},
  {id:83,type:"Moneyline",matchup:"Bills ML vs Dolphins",odds:"-175",stake:"$175",result:"loss",payout:"-$175",date:"Nov 2"},
  {id:82,type:"Player Prop",matchup:"Lamar O55.5 Rush Yds",odds:"-110",stake:"$150",result:"win",payout:"+$136",date:"Nov 2"},
  {id:81,type:"Spread",matchup:"Lions -3.5 vs Packers",odds:"-110",stake:"$200",result:"win",payout:"+$182",date:"Nov 2"},
  {id:80,type:"Over/Under",matchup:"Bengals/Eagles O47",odds:"-110",stake:"$150",result:"win",payout:"+$136",date:"Nov 2"},
  {id:79,type:"Moneyline",matchup:"Cowboys ML vs Falcons",odds:"+160",stake:"$75",result:"loss",payout:"-$75",date:"Nov 2"},
  {id:78,type:"Parlay",matchup:"3-Leg: KC/BUF/DET",odds:"+320",stake:"$75",result:"win",payout:"+$240",date:"Nov 2"},
  {id:77,type:"Spread",matchup:"Ravens -7 vs Browns",odds:"-110",stake:"$150",result:"win",payout:"+$136",date:"Oct 26"},
  {id:76,type:"Moneyline",matchup:"Bengals ML vs Eagles",odds:"+125",stake:"$150",result:"win",payout:"+$188",date:"Oct 26"},
  {id:75,type:"Spread",matchup:"Chiefs -3 vs 49ers",odds:"-110",stake:"$250",result:"win",payout:"+$227",date:"Oct 26"},
  ...
  {id:72,type:"Moneyline",matchup:"Steelers ML vs Jets",odds:"-130",stake:"$130",result:"loss",payout:"-$130",date:"Oct 26"},
  {id:71,type:"Teaser",matchup:"2-Team: KC+3/BAL+1",odds:"-110",stake:"$200",result:"win",payout:"+$182",date:"Oct 26"},
  {id:70,type:"Spread",matchup:"Texans -3 vs Colts",odds:"-110",stake:"$100",result:"loss",payout:"-$100",date:"Oct 26"},
  // === WEEKS 3-4 ===
  {id:69,type:"Spread",matchup:"Lions -7 vs Titans",odds:"-110",stake:"$200",result:"win",payout:"+$182",date:"Oct 19"},
  ...
  {id:66,type:"Player Prop",matchup:"Burrow O270.5 Pass Yds",odds:"-115",stake:"$150",result:"win",payout:"+$130",date:"Oct 19"},
  {id:65,type:"Over/Under",matchup:"Chiefs/Chargers O43",odds:"-110",stake:"$150",result:"win",payout:"+$136",date:"Oct 19"},
  {id:64,type:"Moneyline",matchup:"Ravens ML vs Bucs",odds:"-210",stake:"$210",result:"loss",payout:"-$210",date:"Oct 19"},
  {id:63,type:"Parlay",matchup:"2-Leg: DET ML + KC ML",odds:"+150",stake:"$125",result:"win",payout:"+$188",date:"Oct 19"},
  {id:62,type:"Spread",matchup:"Eagles -5 vs Browns",odds:"-110",stake:"$100",result:"loss",payout:"-$100",date:"Oct 19"},
  {id:61,type:"Spread",matchup:"Chiefs -7 vs Saints",odds:"-110",stake:"$150",result:"win",payout:"+$136",date:"Oct 12"},
  {id:60,type:"Moneyline",matchup:"Lions ML vs Cowboys",odds:"-200",stake:"$200",result:"loss",payout:"-$200",date:"Oct 12"},
  {id:59,type:"Player Prop",matchup:"D. Henry O90.5 Rush",odds:"-120",stake:"$150",result:"win",payout:"+$125",date:"Oct 12"},
  {id:58,type:"Spread",matchup:"Bills -3 vs Jets",odds:"-110",stake:"$200",result:"win",payout:"+$182",date:"Oct 12"},
  ...
  {id:55,type:"Teaser",matchup:"2-Team: KC+3/BUF+3",odds:"-110",stake:"$150",result:"win",payout:"+$136",date:"Oct 12"},
  ...
  {id:50,type:"Player Prop",matchup:"Mahomes O265.5 Pass",odds:"-110",stake:"$150",result:"win",payout:"+$136",date:"Oct 5"},
  {id:49,type:"Over/Under",matchup:"Bills/Texans O46.5",odds:"-110",stake:"$150",result:"win",payout:"+$136",date:"Oct 5"},
  {id:48,type:"Moneyline",matchup:"Eagles ML vs Browns",odds:"-300",stake:"$150",result:"loss",payout:"-$150",date:"Oct 5"},
  {id:47,type:"Parlay",matchup:"3-Leg: KC/DET/PHI",odds:"+280",stake:"$100",result:"win",payout:"+$280",date:"Oct 5"},
  {id:46,type:"Spread",matchup:"Bengals -3 vs Panthers",odds:"-110",stake:"$150",result:"win",payout:"+$136",date:"Sep 28"},
  {id:45,type:"Moneyline",matchup:"Lions ML vs Bears",odds:"-220",stake:"$220",result:"loss",payout:"-$220",date:"Sep 28"},
  {id:44,type:"Spread",matchup:"Ravens -4.5 vs Jaguars",odds:"-110",stake:"$200",result:"win",payout:"+$182",date:"Sep 28"},
  ...
  {id:41,type:"Moneyline",matchup:"49ers ML vs Rams",odds:"-160",stake:"$200",result:"win",payout:"+$125",date:"Sep 28"},
  {id:40,type:"Teaser",matchup:"2-Team: BAL+2/CIN+7",odds:"-110",stake:"$150",result:"win",payout:"+$136",date:"Sep 28"},
  {id:39,type:"Spread",matchup:"Chiefs -3 vs Falcons",odds:"-110",stake:"$200",result:"win",payout:"+$182",date:"Sep 21"},
  {id:38,type:"Moneyline",matchup:"Bengals ML vs Commanders",odds:"-145",stake:"$175",result:"win",payout:"+$121",date:"Sep 21"},
  {id:37,type:"Spread",matchup:"Bills -6 vs Broncos",odds:"-110",stake:"$150",result:"win",payout:"+$136",date:"Sep 21"},
  {id:36,type:"Player Prop",matchup:"Lamar O240.5 Pass Yds",odds:"-110",stake:"$150",result:"win",payout:"+$136",date:"Sep 21"},
  {id:35,type:"Over/Under",matchup:"Lions/Cardinals O47",odds:"-110",stake:"$150",result:"win",payout:"+$136",date:"Sep 21"},
  {id:34,type:"Moneyline",matchup:"Packers ML vs Saints",odds:"+140",stake:"$100",result:"loss",payout:"-$100",date:"Sep 21"},
  {id:33,type:"Parlay",matchup:"2-Leg: KC -3 + BUF -6",odds:"+240",stake:"$100",result:"win",payout:"+$240",date:"Sep 21"},
  {id:32,type:"Spread",matchup:"Lions -3 vs Rams",odds:"-110",stake:"$150",result:"win",payout:"+$136",date:"Sep 14"},
  {id:31,type:"Moneyline",matchup:"Ravens ML vs Cowboys",odds:"-250",stake:"$250",result:"loss",payout:"-$250",date:"Sep 14"},
  {id:30,type:"Spread",matchup:"Chiefs -5 vs Bengals",odds:"-110",stake:"$200",result:"loss",payout:"-$200",date:"Sep 14"},
  {id:29,type:"Player Prop",matchup:"Burrow O260.5 Pass Yds",odds:"-110",stake:"$150",result:"win",payout:"+$136",date:"Sep 14"},
  {id:28,type:"Over/Under",matchup:"Bills/Dolphins O49.5",odds:"-110",stake:"$100",result:"loss",payout:"-$100",date:"Sep 14"},
  {id:27import { useState, useEffect, useMemo, useCallback } from "react";
        ...
        {activeSection==="video"&&(<div>
          ...
          <div style={{background:`linear-gradient(135deg,${pc}44,#12121c)`,border:`1px solid ${ac}33`,borderRadius:14,padding:20,marginBottom:20}}>
            ...
            <div style={{background:"#12121c",borderRadius:12,height:200,display:"flex",alignItems:"center",justifyContent:"center",position:"relative",overflow:"hidden",marginBottom:12}}>
              <img src="https://i.imgur.com/vo46zbi.jpg" alt="Craig Naylor" style={{position:"absolute",inset:0,width:"100%",height:"100%",objectFit:"cover",objectPosition:"center top",filter:"brightness(0.4)"}}/>
              <div style={{position:"absolute",bottom:12,left:14,zIndex:2}}>
                <div style={{background:"#e94560",borderRadius:6,padding:"3px 10px",fontSize:11,fontWeight:700,color:"#fff",display:"inline-block",marginBottom:4}}>FIVE PICK FRIDAYS</div>
                <div style={{fontSize:13,fontWeight:700,color:"#fff",textShadow:"0 1px 4px #000"}}>Week 17 Picks + TNF Recap</div>
              </div>
          ...
          <div style={{display:"flex",flexDirection:"column",gap:8}}>
            {WEEKLY_VIDEOS.slice(1).map(v=>(<div key={v.id} style={{background:"#12121c",border:"1px solid #ffffff10",borderRadius:12,padding:14,display:"flex",alignItems:"center",gap:14,cursor:"pointer"}}>
              <div style={{width:64,height:44,borderRadius:8,background:"#000",display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0,position:"relative",overflow:"hidden"}}>
                <img src="https://i.imgur.com/vo46zbi.jpg" alt="" style={{position:"absolute",inset:0,width:"100%",height:"100%",objectFit:"cover",objectPosition:"center top",filter:"brightness(0.35)"}}/><span style={{fontSize:14,zIndex:1,color:"#fff"}}>▶</span>
              </div>
              <div style={{flex:1,minWidth:0}}>
